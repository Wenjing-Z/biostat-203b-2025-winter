...
```{r}
# # TODO
######## Connect to the labevents table
...
```{r}
# # TODO
###### Retrieve a subset for target subjects 
item_id <- c(
    50912, 
    50971, 
    50983, 
...
```
```{r}
column_order <- (d_labitems_tble$label) |>
  str_to_lower()
...
labevents_tble <- labevents_tble |>
  ...
  # keep the last lab measurements by `storetime`
  mutate(
...
```{r}
# # TODO
#### Connect to the chartevents table
...
mimic_icu_cohort <- mimic_icu_cohort |>
  ...
  mutate(
    first_careunit = fct_lump_n(first_careunit, n = 5, other_level = "Other"),
    last_careunit = fct_lump_n(last_careunit, n = 5, other_level = "Other"),
    ...
    race = fct_collapse(
      ...
      HISPANIC = c("HISPANIC OR LATINO", "HISPANIC/LATINO - SALVADORAN", "HISPANIC/LATINO - CENTRAL AMERICAN", "HISPANIC/LATINO - COLUMBIAN", "HISPANIC/LATINO - CUBAN", "HISPANIC/LATINO - GUATEMALAN", "HISPANIC/LATINO - DOMINICAN", "HISPANIC/LATINO - GUATEMALAN", "HISPANIC/LATINO - COLOMBIAN", "HISPANIC/LATINO - HONDURAN", "HISPANIC/LATINO - NICARAGUAN", "HISPANIC/LATINO - MEXICAN", "HISPANIC/LATINO - PUERTO RICAN"),
...
summary_tbl <- mimic_icu_cohort_1 |>
  tbl_summary(
    by = los_long,
